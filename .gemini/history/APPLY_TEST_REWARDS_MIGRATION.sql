...
-- Система наград за тесты v3.0 - Production Ready
-- Миграция: 20251119000000_create_test_rewards_system.sql
...
DROP POLICY IF EXISTS "Anyone can view active reward configs" ON reward_config;
...
DROP POLICY IF EXISTS "Admins can manage reward configs" ON reward_config;
...
DROP POLICY IF EXISTS "Anyone can view reward config history" ON reward_config_history;
