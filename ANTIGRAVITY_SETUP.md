...
**КРИТИЧЕСКИ ВАЖНО:** Если `.env.local` уже существует (из Cursor), он будет работать и в Antigravity. Если нет - создай файл `.env.local` в корне проекта со следующими переменными:
