-- ВАЖНО: Применяйте миграции в правильном порядке!

-- ШАГ 1: Добавить поле price_stars (если еще не применено)
-- Выполните сначала эту миграцию:
-- supabase/migrations/20250120000007_add_price_stars_field.sql

-- ШАГ 2: Исправить RLS политики
-- Затем эту:
-- supabase/migrations/20250120000008_fix_pricing_packages_rls.sql

-- ШАГ 3: Исправить пакеты монет
-- И наконец эту:
-- supabase/migrations/20250120000009_fix_coins_100_package.sql

-- ============================================
-- ШАГ 1: Добавить поле price_stars
-- ============================================
...
-- ============================================
-- ШАГ 3: Исправить пакеты монет (гарантируем что они существуют и активны)
-- ============================================
