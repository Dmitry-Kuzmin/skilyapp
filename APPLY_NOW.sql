-- Fix: Restore license_audit and daily_bonus_definitions to get_dashboard_super_v2
-- Description:
-- These fields were accidentally removed in the mega fix, causing the event log to be empty.
