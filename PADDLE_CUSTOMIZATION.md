...
1. **Войдите в Paddle Dashboard**: https://vendors.paddle.com/ (вы уже там!)

2. **Найдите настройки брендинга** (2 способа):

   **Способ 1 (через Checkout):**
   - В левом сайдбаре найдите и кликните **"Checkout"**
   - В открывшемся разделе найдите **"Branding"** или **"Appearance"**
   - Или перейдите в **"Checkout Settings"** → **"Branding"**

   **Способ 2 (через Settings):**
   - В левом сайдбаре прокрутите вниз и найдите **"Settings"** (может быть внизу списка)
   - Или кликните на иконку профиля/шестеренку в правом верхнем углу
   - Выберите **"Settings"** → **"Branding"** → **"Checkout appearance"**
