...
async function run() {
  const post = {
    ...
    title: 'Как сдать практический экзамен по вождению с первого раза (2026)',
    excerpt: 'Многие заваливают практику DGT из-за нервов и хитрых ловушек инспектора. Разбираем вопросы до старта и алгоритмы успешной сдачи.',
    content: '<p>Интерактивная статья про ловушки инспекторов.</p>',
