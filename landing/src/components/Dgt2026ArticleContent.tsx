...
const ARTICLE_COPY: Record<Lang, ArticleCopy> = {
  ru: {
    introLead: (
      <>
    ...
    phase1: {
      ...
      cards: [
        { icon: "🛴", title: "Электросамокаты (VMP)", description: "Собственные знаки для устройств персональной мобильности: въезд, парковка, взаимодействие с трафиком.", badge: "новое" },
        { icon: "🌍", title: "Зоны низких выбросов (ZBE)", description: "Обязательны во всех городах Испании с населением 50 000+. Знаки указывают границы, разрешённые ТС и время ограничений.", badge: "новое" },
        { icon: "⚡", title: "Зарядные станции", description: "Знаки для электромобилей и других экологических видов транспорта.", badge: "новое" },
        { icon: "🚗", title: "Полосы VAO", description: "Vehículos de Alta Ocupación — выделенные полосы для машин с несколькими пассажирами.", badge: "новое" },
        { icon: "🛣", title: "Дороги 2+1", description: "Новый формат шоссе с чередующимися полосами обгона, всё чаще встречается в Испании.", badge: "новое" },
        { icon: "🚁", title: "Воздушное наблюдение", description: "Предупреждения о зонах с радарами и дронами DGT.", badge: "новое" },
      ],
    ...
    why: {
      ...
      quotes: [
        { text: "Экзамен оставит позади стадию простого списка вопросов и ответов. Мы хотим знать, как будущий водитель реагирует, видя потенциально опасную ситуацию.", author: "Pere Navarro", role: "Директор DGT" },
        { text: "Мы хотим улучшить качество теоретической подготовки, избежать запоминания и помочь будущим водителям быстро воспринимать риск.", author: "Montserrat Pérez", role: "Заместитель директора DGT по образованию" },
        { text: "Большинство аварий происходит не потому, что правило неизвестно, а потому что его важность не была усвоена.", author: "Sergio Olivera", role: "Генеральный секретарь CNAE (конфедерация автошкол Испании)" },
      ],
      body: (
        <>
    ...
    interview: {
      ...
      items: [
        { question: "Какое самое значимое изменение между старым и новым экзаменом?", answer: "Радикальное смещение от запоминания к пониманию. Раньше можно было «прокачать» базу из 3000 вопросов и сдать. Теперь нужно научиться видеть дорогу, а не просто запоминать ответы." },
        { question: "Как ученики реагируют на видео-вопросы?", answer: "Двояко. Молодые (18–25 лет) — воодушевлены, им интереснее. А вот ученики старше 35–40 лет переживают: они привыкли к классическому формату «вопрос → правильный ответ»." },
        { question: "Какой тип учеников страдает больше всего?", answer: "Те, кто учится «по списку». Хорошо знают правила, но не научились их применять в реальной ситуации. Также страдают «переосмысливающие» — те, кто видит риск везде и парализуется. Идеальный кандидат — понявший логику правил, а не их форму." },
        { question: "Пришлось ли школе переделывать учебные программы?", answer: "Полностью. Добавили видеомодули с первой недели, переработали материалы по знакам, и каждое занятие теперь включает блок «анализ ситуации». Раньше большинство занятий — чистая теория. Сейчас минимум 40% времени уходит на разбор реальных дорожных сцен." },
        { question: "Реально ли сохранить «3 ошибки из 30», когда один вопрос — сложный видео-сценарий?", answer: "Это самый спорный момент. На мой взгляд — да, реально, но только при правильной подготовке. Если ученик просто прошёл базу тестов, он вряд ли сдаст с первого раза. Нужна именно видео-тренировка, а не только текстовые тесты." },
        ...
        { question: "Три самые частые ошибки на видео-вопросах?", answer: "Во-первых, фиксация на очевидной угрозе — ученик видит велосипедиста и забывает про пешехода в зеркале.\n\nВо-вторых, игнорирование погоды и состояния дороги — мокрый асфальт меняет всё.\n\nВ-третьих, слепота к периферии — большинство рисков на видео приходят сбоку, а не из центра кадра." },
        { question: "Достаточно ли традиционных приложений с тестами?", answer: "Больше нет. Любая платформа, которая не предлагает видео-тренировку — устаревшая. Мы рекомендуем ученикам комбинировать традиционные тесты с видео-практикой. К счастью, есть приложения вроде Skilyapp, которые уже встроили это в обучение." },
        { question: "Готовы ли муниципальные центры к переходу?", answer: "67 центров самой DGT — уже да, всё цифровое. А 92 децентрализованных муниципальных центра — в процессе модернизации. Жду задержки в маленьких городах в первые 6 месяцев 2026 года." },
        { question: "Один совет ученику, сдающему экзамен в 2026?", answer: "Выйдите из режима «решения теста» и войдите в режим «вождения». На экзамене вы не отвечаете на вопросы — вы принимаете решения как водитель. Это другая ментальная модель. Кто это поймёт, тот сдаст." },
      ],
    },
    tips: {
  ...
  en: {
    ...
    unchanged: {
      ...
      intro: (<>Before we dive into the changes, the core exam structure <strong>has not changed</strong>:</>),
      stats: [
    ...
    phase1: {
      ...
      body: (<>The first part of the reform went live in October 2025. DGT updated the official road sign catalogue so it now reflects the realities of a modern city: e-scooters, zero-emission zones and electric vehicles.</>),
      cards: [
        { icon: "🛴", title: "E-scooters (VMP)", description: "Dedicated signs for personal mobility vehicles: access, parking and interaction with traffic.", badge: "new" },
        { icon: "🌍", title: "Low-emission zones (ZBE)", description: "Mandatory in every Spanish city with 50,000+ residents. Signs show boundaries, allowed vehicles and time restrictions.", badge: "new" },
        { icon: "⚡", title: "Charging stations", description: "Road signs for electric cars and other eco-friendly transport.", badge: "new" },
        { icon: "🚗", title: "VAO lanes", description: "Vehículos de Alta Ocupación — priority lanes for vehicles carrying multiple passengers.", badge: "new" },
        { icon: "🛣", title: "2+1 roads", description: "A new highway format with alternating overtaking lanes, increasingly common in Spain.", badge: "new" },
        { icon: "🚁", title: "Aerial surveillance", description: "Warnings for areas monitored by DGT radars and drones.", badge: "new" },
      ],
      warningTitle: "Studying with old materials?",
      warningBody: (<>Make sure they were updated for 2025–2026. Skilyapp already refreshed its question bank for the new sign catalogue, so if you have studied before, go back in and retake the sign tests.</>),
    },
    phase2: {
      divider: "Phase 2 — the major change",
      heading: "Phase 2: video questions",
      body: (<>This is what everyone is talking about. For the first time in DGT history, the exam will include <strong>full video clips with real road situations</strong>. Instead of a purely text question, you watch a clip up to 60 seconds long, filmed from the driver's point of view (POV), and then answer a classic multiple-choice question with three options.</>),
      stats: [
      ...
      scenariosIntro: (<>DGT is focusing on situations where most crashes happen because of <strong>an inability to anticipate risk</strong>, not because the rule itself is unknown:</>),
      cards: [
      ...
      officialIntro: (<>DGT has not released actual exam clips publicly. But there is an <strong>official training resource</strong> with 21 videos in exactly the same format as the exam:</>),
      officialCardTitle: "DGT — Test de Predicción de Riesgos",
      officialCardDescription: "21 official videos · each under 60 s · free · in Spanish",
      officialTipTitle: "Best free resource",
      officialTipBody: (<>Go through all 21 videos at least 3–4 times. After every viewing ask yourself: what did I notice? What did I miss?</>),
    },
    why: {
      divider: "Why DGT is doing this",
      heading: "Why DGT is doing this",
      quotes: [
        { text: "The exam is leaving behind the stage of being just a list of questions and answers. We want to know how a future driver reacts when facing a potentially dangerous situation.", author: "Pere Navarro", role: "Director of DGT" },
        { text: "We want to improve the quality of theory training, reduce rote memorisation and help future drivers recognise risk more quickly.", author: "Montserrat Pérez", role: "Deputy Director of Education at DGT" },
        { text: "Most crashes happen not because a rule is unknown, but because its importance was never truly internalised.", author: "Sergio Olivera", role: "General Secretary of CNAE (Spanish driving school confederation)" },
      ],
      body: (<>CNAE has lobbied for this change for years, pointing to the experience of the United Kingdom, Germany, France, Finland and Latvia, where video-based testing is already in place. The British result is especially telling: after Hazard Perception Test was introduced in 2002, crash rates among young drivers <strong>fell by 11%</strong> in the first years.</>),
    },
    harder: {
      divider: "Is it harder now?",
      heading: "Is it harder now?",
      warningTitle: "The honest answer: yes",
      warningBody: (<>If you rely on memorising answers, then absolutely yes. Video questions are designed specifically to <strong>break the "rote learner" approach</strong>.</>),
      comparison: {
        headerA: "Old exam",
      ...
      table: {
        ...
        caption: "Source: DGT 2025. After adaptation (2–3 years), results should stabilise again, as happened in the UK.",
      },
    },
    interview: {
      divider: "Interview: a driving school insider's view",
      heading: "Interview: a driving school insider's view",
      intro: (<>The director of a major Costa del Sol driving school — anonymous but candid — answered 10 key questions about the reform.</>),
      accordionTitle: "10 questions for a driving school director",
      items: [
        { question: "What is the biggest change between the old and new exam?", answer: "A radical shift from memorisation to understanding. Before, you could grind through a bank of 3,000 questions and pass. Now you have to learn to read the road, not just remember answers." },
        { question: "How are students reacting to video questions?", answer: "It is mixed. Younger learners (18–25) are excited because it feels more engaging. Students over 35–40 are more anxious because they are used to the classic \"question → correct answer\" format." },
        { question: "Which learners suffer the most?", answer: "Those who study \"from a list\". They know the rules well but never learned to apply them in real situations. Overthinkers also struggle — they see danger everywhere and freeze. The ideal candidate understands the logic behind the rules, not just their wording." },
        { question: "Did your school have to rebuild the training programme?", answer: "Completely. We added video modules from week one, rebuilt our sign materials, and now every class includes a situation-analysis block. Before, most lessons were pure theory. Now at least 40% of the time is spent analysing real road scenes." },
        { question: "Can Spain realistically keep \"3 mistakes out of 30\" if one question is a complex video scenario?", answer: "That is the most debated point. In my view, yes — but only with the right preparation. If a learner just completes a standard question bank, a first-time pass is unlikely. They need real video practice, not only text tests." },
        { question: "Do you believe Spain will reduce crash rates the way Britain did?", answer: "I do. The biggest crash victims in Spain are drivers aged 18–24, and they are the weakest at reading the road. If the exam forces them to anticipate situations before they ever get a licence, it will save lives. Not instantly, but within 3–5 years for sure." },
        { question: "What are the three most common mistakes in video questions?", answer: "First, tunnel vision on the obvious threat — a student sees the cyclist and forgets about the pedestrian in the mirror.\n\nSecond, ignoring weather and road condition — wet asphalt changes everything.\n\nThird, peripheral blindness — most risks in these clips come from the side, not from the centre of the frame." },
        { question: "Are traditional test apps still enough?", answer: "Not anymore. Any platform that does not offer video training is already outdated. We advise students to combine standard tests with video practice. Fortunately, there are apps like Skilyapp that have already built this into the learning flow." },
        { question: "Are local testing centres ready for the transition?", answer: "The 67 DGT-run centres are basically ready — they are already digital. The 92 decentralised municipal centres are still upgrading. I expect delays in smaller towns during the first six months of 2026." },
        { question: "One piece of advice for a student taking the exam in 2026?", answer: "Leave \"test-solving mode\" and enter \"driving mode\". In the exam you are not answering trivia — you are making decisions like a driver. That is a different mental model. The people who understand this will pass." },
      ],
    },
    tips: {
    ...
    skilyapp: {
      ...
      cta: {
        ...
        description: "24/7 AI tutor, full 2026 question bank and exam simulation for the new format. Russian, Spanish and English.",
    ...
    conclusion: {
      ...
      summaryBody: (<>The reform is demanding, but logical. DGT wants to produce not just "exam passers", but <strong>real drivers</strong>. That benefits everyone on the road.</>),
    },
  },
  es: {
    introLead: (
    ...
    creatorBody: (<>Soy el fundador de Skilyapp. Ayudamos a las personas a prepararse para la DGT con IA. En los últimos meses hemos rediseñado la plataforma para este nuevo formato y quiero contarte lo que hemos aprendido.</>),
    unchanged: {
      heading: "Qué no cambia",
      intro: (<>Antes de entrar en las novedades, la estructura básica del examen <strong>no ha cambiado</strong>:</>),
      stats: [
    ...
    phase1: {
      ...
      body: (<>La primera parte de la reforma se activó en octubre de 2025. La DGT actualizó el catálogo oficial de señales para incluir la realidad de la ciudad moderna: patinetes eléctricos, zonas de bajas emisiones y vehículos eléctricos.</>),
      cards: [
        { icon: "🛴", title: "Patinetes eléctricos (VMP)", description: "Señales específicas para vehículos de movilidad personal: acceso, aparcamiento e interacción con el tráfico.", badge: "nuevo" },
        { icon: "🌍", title: "Zonas de bajas emisiones (ZBE)", description: "Obligatorias en todas las ciudades españolas de más de 50.000 habitantes. Las señales indican límites, vehículos permitidos y franjas horarias.", badge: "nuevo" },
        { icon: "⚡", title: "Puntos de recarga", description: "Señales para coches eléctricos y otros medios de transporte ecológicos.", badge: "nuevo" },
        { icon: "🚗", title: "Carriles VAO", description: "Vehículos de Alta Ocupación: carriles reservados para coches con varios ocupantes.", badge: "nuevo" },
        { icon: "🛣", title: "Carreteras 2+1", description: "Nuevo formato de vía con carriles de adelantamiento alternos, cada vez más frecuente en España.", badge: "nuevo" },
        { icon: "🚁", title: "Vigilancia aérea", description: "Avisos de zonas con radares y drones de la DGT.", badge: "nuevo" },
      ],
      warningTitle: "¿Estudiaste con materiales antiguos?",
      warningBody: (<>Comprueba si están actualizados a la versión 2025–2026. Skilyapp ya ha adaptado la base de preguntas al nuevo catálogo, así que si ya estudiabas antes, entra y repite el test de señales.</>),
    },
    phase2: {
      divider: "Fase 2 — la gran novedad",
      heading: "Fase 2: preguntas en vídeo",
      body: (<>Este es el cambio del que todo el mundo habla. Por primera vez en la historia de la DGT, el examen incluirá <strong>vídeos completos con situaciones reales de tráfico</strong>. En lugar de una pregunta solo de texto, verás un vídeo de hasta 60 segundos, grabado desde el punto de vista del conductor (POV), y después responderás una pregunta clásica con tres opciones.</>),
      stats: [
      ...
      scenariosIntro: (<>La DGT se centra en situaciones donde la mayoría de los accidentes ocurren por <strong>no anticipar el riesgo</strong>, no por desconocer la norma:</>),
      cards: [
      ...
      officialIntro: (<>La DGT no ha publicado vídeos reales del examen. Pero sí existe un <strong>recurso oficial de entrenamiento</strong> con 21 vídeos idénticos en formato al examen:</>),
      officialCardTitle: "DGT — Test de Predicción de Riesgos",
      officialCardDescription: "21 vídeos oficiales · cada uno <60 s · gratis · en español",
      officialTipTitle: "El mejor recurso gratuito",
      officialTipBody: (<>Haz los 21 vídeos al menos 3–4 veces. Después de cada visualización pregúntate: ¿qué he visto? ¿Qué se me escapó?</>),
    },
    why: {
      divider: "Por qué la DGT hace esto",
      heading: "Por qué la DGT hace esto",
      quotes: [
        { text: "El examen dejará atrás la etapa de ser simplemente una lista de preguntas y respuestas. Queremos saber cómo reacciona un futuro conductor cuando ve una situación potencialmente peligrosa.", author: "Pere Navarro", role: "Director de la DGT" },
        { text: "Queremos mejorar la calidad de la preparación teórica, evitar la memorización mecánica y ayudar a los futuros conductores a percibir el riesgo con mayor rapidez.", author: "Montserrat Pérez", role: "Subdirectora de Formación de la DGT" },
        { text: "La mayoría de los accidentes no ocurre porque la norma sea desconocida, sino porque su importancia nunca fue realmente interiorizada.", author: "Sergio Olivera", role: "Secretario general de la CNAE" },
      ],
      body: (<>La CNAE lleva años impulsando este cambio, apoyándose en la experiencia del Reino Unido, Alemania, Francia, Finlandia y Letonia, donde las pruebas en vídeo ya existen. El caso británico es especialmente relevante: tras la introducción del Hazard Perception Test en 2002, la siniestralidad entre conductores jóvenes <strong>bajó un 11%</strong> en los primeros años.</>),
    },
    harder: {
      divider: "¿Será más difícil?",
      heading: "¿Será más difícil?",
      warningTitle: "La respuesta honesta: sí",
      warningBody: (<>Para quien depende de memorizar respuestas, sí. Las preguntas en vídeo están pensadas precisamente para <strong>romper el enfoque de empollar</strong>.</>),
      comparison: {
      ...
      table: {
        ...
        caption: "Fuente: DGT 2025. Tras el periodo de adaptación (2–3 años), los resultados deberían estabilizarse, igual que ocurrió en Reino Unido.",
      },
    },
    interview: {
      divider: "Entrevista: visión desde dentro de una autoescuela",
      heading: "Entrevista: visión desde dentro de una autoescuela",
      intro: (<>El director de una gran autoescuela de la Costa del Sol — de forma anónima, pero muy sincera — respondió a 10 preguntas clave sobre la reforma.</>),
      accordionTitle: "10 preguntas al director de una autoescuela",
      items: [
        { question: "¿Cuál es el cambio más importante entre el examen antiguo y el nuevo?", answer: "Un cambio radical de la memorización a la comprensión. Antes se podía repetir una base de 3.000 preguntas y aprobar. Ahora hay que aprender a leer la carretera, no solo a recordar respuestas." },
        { question: "¿Cómo reaccionan los alumnos ante las preguntas en vídeo?", answer: "De manera mixta. Los más jóvenes (18–25 años) están motivados porque les resulta más interesante. Los alumnos mayores de 35–40 años lo viven con más ansiedad porque están acostumbrados al formato clásico de \"pregunta → respuesta correcta\"." },
        { question: "¿Qué tipo de alumno lo pasa peor?", answer: "Quien estudia \"por lista\". Conoce bien las normas, pero no ha aprendido a aplicarlas en una situación real. También sufre quien sobreanaliza: ve peligro en todas partes y se bloquea. El candidato ideal entiende la lógica de las normas, no solo su forma." },
        { question: "¿La autoescuela tuvo que rehacer el programa?", answer: "Por completo. Añadimos módulos de vídeo desde la primera semana, rehacimos los materiales de señales y ahora cada clase incluye análisis de situaciones. Antes la mayoría del tiempo era teoría pura. Ahora al menos un 40% se dedica a escenas reales de tráfico." },
        { question: "¿Es realista mantener \"3 fallos de 30\" si una pregunta puede ser un escenario complejo en vídeo?", answer: "Ese es el punto más discutido. En mi opinión, sí, pero solo con la preparación adecuada. Si el alumno solo ha hecho una base de test estándar, es difícil que apruebe a la primera. Hace falta entrenamiento en vídeo, no solo test de texto." },
        { question: "¿Cree que España reducirá los accidentes como ocurrió en Reino Unido?", answer: "Estoy convencido. Las principales víctimas de los accidentes en España son los conductores de 18 a 24 años, y precisamente son quienes peor leen la carretera. Si el examen les obliga a anticipar situaciones antes de obtener el carné, salvará vidas. No de inmediato, pero sí en 3–5 años." },
        { question: "¿Cuáles son los tres errores más comunes en las preguntas en vídeo?", answer: "Primero, fijarse solo en la amenaza obvia: el alumno ve al ciclista y olvida al peatón que aparece en el espejo.\n\nSegundo, ignorar el clima y el estado de la calzada: el asfalto mojado lo cambia todo.\n\nTercero, la ceguera periférica: la mayoría de los riesgos en estos vídeos llega desde los lados, no desde el centro." },
        { question: "¿Siguen siendo suficientes las apps tradicionales de tests?", answer: "Ya no. Cualquier plataforma que no ofrezca entrenamiento en vídeo está desactualizada. Recomendamos combinar tests clásicos con práctica en vídeo. Por suerte, ya hay apps como Skilyapp que lo han integrado en el aprendizaje." },
        { question: "¿Están preparados los centros de examen para la transición?", answer: "Los 67 centros gestionados directamente por la DGT sí, porque ya son digitales. Los 92 centros municipales descentralizados siguen modernizándose. Espero retrasos en ciudades pequeñas durante los primeros seis meses de 2026." },
        { question: "Un consejo para quien haga el examen en 2026", answer: "Sal del modo \"resolver test\" y entra en modo \"conducir\". En el examen no respondes a una trivia: tomas decisiones como conductor. Es otro modelo mental. Quien entienda eso, aprobará." },
      ],
    },
    tips: {
    ...
    skilyapp: {
      ...
      cta: {
        ...
        description: "Tutor con IA 24/7, base completa de preguntas 2026 y simulación del examen con el nuevo formato. Ruso, español e inglés.",
    ...
    conclusion: {
      ...
      summaryBody: (<>La reforma es exigente, pero lógica. La DGT quiere formar no solo a gente que aprueba, sino a <strong>conductores reales</strong>. Eso beneficia a todos los que compartimos la vía.</>),
    },
  },
};

export function Dgt2026ArticleContent({ lang = "es" }: { lang?: string }) {
  const copy = ARTICLE_COPY[(lang as Lang)] ?? ARTICLE_COPY.ru;
