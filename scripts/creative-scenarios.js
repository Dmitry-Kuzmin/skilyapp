export const CREATIVE_SCENARIOS = [
    ...
    { id: 202, category: "Urban", keywords: ["rain", "night", "neon", "noche", "luz"], text: "Bilbao Riverside at Night: The iconic Guggenheim Museum's titanium curves glow amber in the reflection of the Nervión river. Wet cobblestones shine with city lights. A lone Skily car drives across the sleek Zubizuri footbridge area. The mood is cinematic, electric, and rich." },
