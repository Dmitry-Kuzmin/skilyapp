...
export function CinematicHero({
  ...
  return (
    <div
      className={cn(
        'relative w-screen min-h-[80vh] flex flex-col items-center justify-between bg-[#050B14] text-white font-sans antialiased overflow-hidden',
        className
      )}
      {...props}
    >
      ...
      <div className="flex flex-col items-center justify-center relative px-4 text-center z-20 w-full pt-24 sm:pt-32 pb-8">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-7xl font-black mb-6 tracking-tight text-white drop-shadow-lg px-2">
          {ctaHeading}
        </h1>
        ...
        >
          <div className="flex flex-col sm:flex-row items-center gap-5 sm:gap-6 w-full max-w-[650px] px-4 justify-center z-30">
            ...
            >
              ...
              <div className="relative flex flex-col justify-center w-full text-center h-full items-center z-10 rounded-[45px] bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10">
      ...
      <div className="w-full px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-white/5 bg-[#050B14]/40 z-20 mt-auto backdrop-blur-sm">
        ...
        <div className="text-[10px] sm:text-xs text-zinc-600">
          &copy; {new Date().getFullYear()} Sdadim.eu. Все права защищены.
        </div>
      </div>
    </div>
  );
