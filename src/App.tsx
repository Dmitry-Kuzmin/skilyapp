...
// Lazy load всех страниц для оптимизации загрузки
...
const AdminSync = lazy(() => import("./pages/admin/AdminSync").then(m => ({ default: m.AdminSync })));
const AdminImport = lazy(() => import("./pages/admin/AdminImport").then(m => ({ default: m.AdminImport })));
const AdminPDFUpload = lazy(() => import("./pages/admin/AdminPDFUpload").then(m => ({ default: m.AdminPDFUpload })));
