                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Термин считается изученным, если вы правильно ответили на него <strong>3 раза</strong> в играх (Race, Лексикон и др.).
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                  ...
                  <div className="pt-2 border-t border-border/50">
                    <p className="text-xs text-muted-foreground">
                      <strong>Важно:</strong> Прогресс обновляется только в играх, связанных с терминами (Race, Лексикон).
            ...
            <div className="space-y-4">
              ...
              {recentProgress.length > 0 ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  Еще нет недавнего прогресса. Начните с игр Race или «Лексикон».
                </div>
              )}
            </div>
