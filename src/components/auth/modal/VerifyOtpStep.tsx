...
export function VerifyOtpStep({
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between gap-1.5 max-w-[340px] mx-auto">
                {otp.map((digit, index) => (
                    <input
                        key={index}
                        ...
                        className="w-9 h-12 text-center text-xl font-bold bg-white/5 border border-white/10 rounded-lg text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all outline-none"
                    />
                ))}
            </div>
