...
export function CryptomusPaymentPreview({
  ...
  // Общий контент карточки с деталями платежа
        ...
        <DrawerPrimitive.Portal>
          ...
          >
            ...
            <div className="flex-1 flex flex-col overflow-hidden px-4 pb-4">
              <div className="flex-1 overflow-y-auto py-3 scrollbar-none overscroll-contain" style={{ WebkitOverflowScrolling: 'touch' }}>
                <div className="space-y-4">
                  <div className="space-y-2">
                    <h2 className="text-lg font-semibold">{t('cryptomusPayment.title')}</h2>
