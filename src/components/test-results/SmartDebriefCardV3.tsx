...
// Motion removed to fix LazyMotion conflict
...
// ============================================================================
// Промпт перенесен в /lib/aiPrompts.ts для переиспользования
// ============================================================================
  ...
  return (
    <>
      <div
        ...
        className="mb-10 cursor-pointer animate-in fade-in zoom-in-95 duration-500 hover:scale-[1.01] active:scale-[0.98] transition-transform"
