...
export const GameBackground = memo(({ mode, timeLeft, maxTime = 300, streak = 0 }: GameBackgroundProps) => {
    ...
    return (
        <div className="fixed inset-0 z-[-1] overflow-hidden pointer-events-none">
            ...
            {/* Floating Orbs - Hidden on mobile as requested by user */}
            <div className="hidden sm:block absolute top-1/4 left-1/4 w-96 h-96 bg-blue-500/20 rounded-full blur-[100px] animate-pulse" />
            <div className="hidden sm:block absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-500/20 rounded-full blur-[100px] animate-pulse delay-1000" />
        </div>
    );
});
