...
export function CinematicHero({ 
  brandName = "SKILY",
  tagline1 = "Готовься к DGT,",
  tagline2 = "а не просто зубри.",
  cardHeading = "Теория, переосмысленная.",
  cardDescription = <><span className="text-white font-semibold flex items-center gap-2"><Send className="w-5 h-5 text-sky-400" /> Skilyapp</span> помогает студентам автошкол в Испании подготовиться к теоретическому экзамену DGT быстрее с помощью умных алгоритмов и живой поддержки.</>,
  metricValue = 16000,
  metricLabel = "Вопросов DGT",
  ctaHeading = "Начни учиться.",
  ctaDescription = "Присоединяйся к сотням студентов, успешно сдавших экзамен с первого раза, и получи права уже этой весной.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      if (window.scrollY < containerRef.current!.offsetTop - window.innerHeight / 2 || window.scrollY > containerRef.current!.offsetTop + window.innerHeight * 2) return;
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        .to(".counter-val", { innerHTML: metricValue, snap: { innerHTML: 5 }, duration: 2, ease: "expo.out" }, "-=2.0")
  ...
  return (
    ...
    >
      ...
      {/* BACKGROUND LAYER 2: Tactile CTA Buttons -> now PULSE BEAMS */}
      <div className="cta-wrapper absolute inset-0 z-10 gsap-reveal pointer-events-none w-screen h-screen">
        <PulseBeams
          beams={beams}
        ...
        >
          <div className="flex flex-col items-center justify-center h-full relative px-4 text-center pointer-events-auto z-10">
           {/* Фраза-наживка внутри финального экрана */}
             ...
             {/* The new glowing dark button */}
             <a href="https://t.me/skilyapp_bot" target="_blank" rel="noopener noreferrer" className="bg-slate-800 w-[300px] sm:w-[320px] h-[90px] no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-[45px] p-px text-xs font-semibold leading-6 text-white inline-block">
               ...
               <div className="relative flex justify-center w-full h-full text-center space-x-4 items-center z-10 rounded-[45px] bg-zinc-950 py-0.5 px-6 ring-1 ring-white/10">
                 <div className="w-[48px] h-[48px] rounded-full bg-[#2EA5E0] flex items-center justify-center shadow-md">
                   <Send className="w-6 h-6 text-white ml-[-2px] mt-[1px]" />
                 </div>
                 <div className="text-left flex flex-col justify-center">
                   <div className="text-[11px] font-bold tracking-[0.15em] text-neutral-400 uppercase mb-[-1px]">Открыть в</div>
                   <div className="text-[28px] font-black leading-none tracking-tight text-white bg-clip-text text-transparent bg-gradient-to-r from-white via-blue-100 to-white">Telegram</div>
                 </div>
               </div>
             ...
             <p className="text-zinc-400 text-sm md:text-base mt-20 max-w-xl mx-auto font-light leading-relaxed">
               {ctaDescription}
             </p>
          </div>
          
          {/* Integrated Footer Links */}
          <div className="absolute bottom-0 left-0 w-full px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-white/5 bg-[#050B14]/80 backdrop-blur-xl pointer-events-auto z-20">
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="card-right-text gsap-reveal order-1 lg:order-3 flex justify-center lg:justify-end z-20 w-full">
              <h2 className="text-6xl md:text-[6rem] lg:text-[8rem] font-black uppercase tracking-tighter text-card-silver-matte lg:mt-0 flex gap-2">
                <Send className="w-16 h-16 md:w-32 md:h-32 text-white/50 inline-block drop-shadow-lg" />
              </h2>
            </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                <div
                  ref={mockupRef}
                  className="relative w-[280px] h-[580px] rounded-[3rem] iphone-bezel flex flex-col will-change-transform transform-style-3d bg-[#111]"
                  style={{ backgroundImage: "linear-gradient(to right, #000, #444, #000)" }}
                >
                  <div className="absolute inset-0 rounded-[3rem] shadow-[inset_0_0_15px_black] z-50 pointer-events-none" />
                  ...
                  <div className="absolute inset-[7px] bg-[#0A101D] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10 border border-white/5">
                    <div className="absolute inset-0 screen-glare z-40 pointer-events-none" aria-hidden="true" />

                    {/* Dynamic Island Notch */}
                    <div className="absolute top-[5px] left-1/2 -translate-x-1/2 w-[100px] h-[26px] bg-black/90 backdrop-blur-md rounded-full z-50 flex items-center justify-end px-3 shadow-[inset_0_-1px_2px_rgba(255,255,255,0.05)] border border-white/10">
                      <div className="w-[4px] h-[4px] rounded-full bg-emerald-500 shadow-[0_0_6px_rgba(16,185,129,0.8)] animate-pulse" />
                    </div>
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-zinc-400 uppercase tracking-widest font-bold mb-1">Прогресс</span>
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Обучение</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-blue-600/20 text-blue-400 flex items-center justify-center font-bold text-sm border border-blue-500/30 shadow-lg shadow-black/50 overflow-hidden">
                          <img src="/logo192.png" alt="" className="w-full h-full object-cover opacity-80" />
                        </div>
                      </div>
                      ...
                      <div className="phone-widget relative w-44 h-44 mx-auto flex items-center justify-center mb-8 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                        <svg className="absolute inset-0 w-full h-full" aria-hidden="true">
                          ...
                          <circle className="progress-ring" cx="88" cy="88" r="64" fill="none" stroke="#2EA5E0" strokeWidth="12" />
                        </svg>
                        <div className="text-center z-10 flex flex-col items-center">
                          <span className="counter-val text-4xl font-extrabold tracking-tighter text-white drop-shadow-md">0</span>
                          <span className="text-[9px] text-blue-300 uppercase tracking-[0.05em] font-bold mt-1 text-center leading-tight opacity-70">
                            {metricLabel}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center bg-white/[0.02]">
                          ...
                          <div className="flex-1">
                            <div className="text-xs font-bold text-white mb-0.5">Тема 1. Сигналы</div>
                            <div className="text-[9px] font-medium text-blue-200/60 uppercase tracking-widest">Пройдено на 100%</div>
                          </div>
                        </div>
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center bg-white/[0.02]">
                          ...
                          <div className="flex-1">
                            <div className="text-xs font-bold text-white mb-0.5">Симуляция экзамена</div>
                            <div className="text-[9px] font-medium text-emerald-300/60 uppercase tracking-widest">3 Ошибки: Сдано</div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Отлично!</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Шанс сдачи 98%</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Лучший результат</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">29/30 правильных</p>
                  </div>
                </div>
