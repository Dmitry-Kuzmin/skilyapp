...
- **Жирный текст** (двойные звёздочки **термин**) для терминов и ключевых моментов
- Используй списки (- или 1.) для перечисления
- Эмодзи в начале важных блоков
- Короткие параграфы (2-3 предложения max)

⚠️ **КРИТИЧНО**: 
- Для выделения текста ВСЕГДА используй двойные звёздочки: **так**
- НЕ используй одинарные звёздочки (*так*) - они НЕ работают
- Списки начинай с дефиса или цифры
