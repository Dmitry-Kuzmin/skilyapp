...
## Что добавилось
- **Сценарии с фото и видео** — нужно за секунды понять контекст и выбрать безопасное действие.
- **Комбинированные вопросы** — один кейс разбивается на 2–3 подпункта.
- **Ассистенты водителя** — на теории спрашивают про ACC, Lane Assist и умение их отключать.

## Как тренироваться
1. В Skilyapp включите фильтр «Новые вопросы 2025» — там собраны первые загрузки свежих билетов.
2. Используйте RaceGame и дуэли — они ускоряют чтение текста и реакцию.
3. После каждого вопроса сохраняйте карточку и просите AI-помощника пояснить логику на русском.

## Чек-лист перед экзаменом
- Пройдите одну симуляцию со включённым таймером.
- Повторите тему «ассистенты и электроника» — она теперь считается критичной.
- Зайдите в раздел «Опасные ситуации» и убедитесь, что там нет красных зон.
...
## Важные метрики
- **Точность по темам** — всё, что ниже 70%, требует внимания.
- **Streak в модуле** показывает, когда знания «остывают».
- **Опасные ситуации** раскрывают, где вы поздно замечаете риск.

## Алгоритм
1. Выберите слабую тему в аналитике Skilyapp.
2. Пройдите быстрый тест только по ней и сохраните ошибки.
3. Попросите AI-помощника объяснить их и добавьте заметки.
4. На следующий день сыграйте дуэль, чтобы проверить, закрепилось ли решение.
