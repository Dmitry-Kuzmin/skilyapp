...
const articles: Article[] = [
  ...
  },
  {
    ...
    description: "Большая 20-минутная статья о том, как карта обучения, Lumi, дуэли, игры и микротренировки работают вместе ради вашего результата.",
    excerpt: "Погружаемся в экосистему Skilyapp: карта обучения, микротренировки, игры, сезоны, Telegram-бот и AI-компаньон Lumi — всё в одной заботливой связке.",
    publishedAt: "2025-03-08",
    readTime: 20,
    category: "Актуально",
    categorySlug: "news",
