...
const articles: Article[] = [
  {
    ...
    description: "Что поменялось в теории и почему важно обновить стратегию подготовки прямо сейчас.",
    excerpt: "Разбираем свежие изменения экзамена DGT: больше сценариев риска, адаптивная шкала ошибок и фокус на цифровых навыках. Показываем, как Skilyapp помогает учесть всё в одном плане.",
  ...
  },
  {
    ...
    description: "Геймификация и соревнования помогают держать темп. Делимся рабочими схемами.",
    excerpt: "Сравниваем классическую зубрёжку с дуэлями Skilyapp: личный рейтинг, сезонные награды и push-напоминания, которые не дают выпасть из процесса.",
  ...
  },
  {
    ...
    description: "Переключаемся между языками без стресса: словарь, примеры и AI-пояснения.",
    excerpt: "Рассказываем, как сочетать русскую теорию и испанские формулировки, чтобы на экзамене не зависать на незнакомых словах. Секрет — переводчик и словарь Skilyapp.",
  ...
  },
  {
    ...
    description: "Подробная инструкция, чтобы не потеряться в бюрократии: от psicotécnico до оплаты tasas.",
    excerpt: "Выполняем весь путь записи на экзамен без паники: документы, портал DGT, сроки оплаты и как Skilyapp напоминает о дедлайнах.",
  ...
  },
  {
    ...
    description: "Техника Pomodoro, дыхательные практики и спокойные симуляции — всё, чтобы не выгореть за неделю до экзамена.",
    excerpt: "Собрали план на 5 дней с микротренировками и трекингом настроения. Skilyapp помогает удержать баланс между практикой и отдыхом.",
