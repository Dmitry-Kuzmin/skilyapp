...
• Рекламные (Google AdSense): для показа персонализированной рекламы на основе ваших интересов.`
                },
                {
                    title: "3. Сторонние файлы cookie",
                    content: "Мы используем услуги сторонних компаний, таких как Google AdSense и Vercel Analytics. Эти компании могут устанавливать свои файлы cookie для сбора информации о ваших посещениях этого и других сайтов с целью предоставления объявлений о товарах и услугах, которые могут вас заинтересовать."
                },
                {
