...
const TESTIMONIALS = [
  {
    text: "Три раза заваливалась — с книжкой на испанском не понимала половины вопросов. Здесь за пять недель разобрала всё по полочкам. Сдала — 27 из 30. До сих пор не верю.",
    image: "https://randomuser.me/api/portraits/women/44.jpg",
    name: "Ольга Семёнова",
    role: "Барселона · домохозяйка",
  },
  {
    text: "Работаю в строительстве, обед — 20 минут. Учился с телефона прямо в машине. Куратор сам разобрался с записью в DGT, мне осталось только приехать и сдать.",
    image: "https://randomuser.me/api/portraits/men/32.jpg",
    name: "Виктор Лученко",
    role: "Мадрид · строитель",
  },
  {
    text: "Мне 55 — честно боялась, что не осилю. Материал объяснён так, что всё встаёт на место. Сдала 28 из 30. Внучка попросила показать сертификат.",
    image: "https://randomuser.me/api/portraits/women/68.jpg",
    name: "Наталья Воронцова",
    role: "Аликанте · пенсионерка",
  },
  {
    text: "Понимал испанский на базовом уровне, но вопросы в DGT — это вообще отдельный язык. Куратор разбирал каждую формулировку, отвечал в тот же день. Сдал с первого раза.",
    image: "https://randomuser.me/api/portraits/men/26.jpg",
    name: "Артём Ковалёв",
    role: "Валенсия · менеджер",
  },
  {
    text: "Переехала с двумя детьми. Куратор взял на себя всю бумажную часть — cita, tasa, документы. Я просто готовилась. Без этой помощи я бы потонула.",
    image: "https://randomuser.me/api/portraits/women/35.jpg",
    name: "Марина Фёдорова",
    role: "Малага · мама двоих детей",
  },
  {
    text: "Мои иностранные права в Испании не признали — пришлось сдавать с нуля. Думал, провалюсь. Но система выстроена так, что к экзамену подходишь уверенно. Сдал через два месяца.",
    image: "https://randomuser.me/api/portraits/men/47.jpg",
    name: "Сергей Романов",
    role: "Бильбао · инженер",
  },
  {
    text: "DGT-испанский — это отдельный мир. Учила язык 3 года, но вопросы всё равно путали. Здесь разобрали именно те формулировки, которые встречаются на экзамене. Сдала на испанском.",
    image: "https://randomuser.me/api/portraits/women/54.jpg",
    name: "Светлана Журавлёва",
    role: "Севилья · переводчик",
  },
  {
    text: "Занятия в записи, платформа в телефоне, куратор отвечает когда удобно. Никаких расписаний. Прошёл параллельно с запуском бизнеса — и сдал.",
    image: "https://randomuser.me/api/portraits/men/59.jpg",
    name: "Дмитрий Прохоров",
    role: "Мадрид · предприниматель",
  },
  {
    text: "Работаю посменно, график скачет. Занималась когда могла — в транспорте, между сменами. Приложение Skily шло в комплекте с курсом. Сдала с первого раза.",
