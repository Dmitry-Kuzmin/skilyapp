      ...
      subsections: [
        {
          ...
          content: getTranslatedContent("help.content.welcome.intro.content", `Skilyapp — это интерактивное приложение для подготовки к экзамену на получение водительских прав в Испании (DGT). Мы помогаем вам эффективно изучать правила дорожного движения, дорожные знаки и сдавать экзамены с удовольствием.
...
Делитесь своей реферальной ссылкой и помогайте друзьям готовиться к экзамену, получая за это награды!`)
        }
      ]
    },
    {
