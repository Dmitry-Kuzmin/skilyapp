  ...
  const sections: Section[] = [
    {
      ...
      subsections: [
        {
          id: "welcome-intro",
          title: getTranslatedContent("help.content.welcome.intro.title", "Что такое Sdadim?"),
          content: getTranslatedContent("help.content.welcome.intro.content", `Sdadim — это интерактивное приложение для подготовки к экзамену на получение водительских прав в Испании (DGT). Мы помогаем вам эффективно изучать правила дорожного движения, дорожные знаки и сдавать экзамены с удовольствием.
...
• Искусственный интеллект для объяснения сложных тем`)
        },
        {
          ...
          content: getTranslatedContent("help.content.welcome.gettingStarted.content", `Чтобы начать использовать Sdadim:
      ...
      subsections: [
        {
          ...
          content: getTranslatedContent("help.content.notifications.overview.content", `Sdadim поддерживает уведомления через Telegram бота, чтобы вы не пропускали важные события и мотивировали себя к регулярным занятиям.
      ...
      subsections: [
        {
          ...
          content: getTranslatedContent("help.content.rewards.overview.content", `В Sdadim существует система достижений, которая мотивирует вас к регулярным занятиям. За выполнение различных действий вы получаете достижения и награды.`)
        },
        {
...
• Мастер ПДД — набрать 4000 очков опыта (бейдж)`)
        },
        {
          ...
          content: getTranslatedContent("help.content.rewards.dailyBonus.content", `Заходите каждый день и получайте награды! Система ежедневных бонусов работает по принципу серий:
...
Если пропустите день, серия сбрасывается. Но вы можете восстановить её за 10 монет.`)
        },
        {
          ...
          content: getTranslatedContent("help.content.rewards.referral.content", `Приглашайте друзей и получайте награды:
...
Ответ: Зависит от страны происхождения. ЕС права действительны, для других стран может потребоваться обмен или пересдача.`)
    ...
    },
    {
      ...
      title: "Правила",
      icon: Scale,
      description: "Правила использования приложения и условия предоставления услуг",
      subsections: [
        {
          id: "rules-general",
          title: "Общие правила использования",
          content: `Используя приложение Sdadim, вы соглашаетесь соблюдать следующие правила:
...
• Соблюдайте этику общения в дуэлях и сообществах`
        ...
        {
          id: "rules-premium",
          title: "Правила Premium подписки",
          content: `**Premium Forever:**
...
• Никаких платежей в течение пробного периода`
        ...
        {
          id: "rules-duels",
          title: "Правила дуэлей",
          content: `**Дуэли без ставки:**
...
• Нарушения могут привести к блокировке аккаунта`
        ...
        {
          id: "rules-refunds",
          title: "Возврат средств и отмена",
      ...
      subsections: [
        {
          ...
          items: (t("help.content.faq.general.items") as string[]).map((item, index) => {
            const fallback = [
            ...
            return item !== `help.content.faq.general.items[${index}]` ? item : fallback[index] || item;
          })
        },
        {
          id: "faq-technical",
          title: getTranslatedContent("help.content.faq.technical.title", "Технические вопросы"),
          items: (t("help.content.faq.technical.items") as string[]).map((item, index) => {
            const fallback = [
            ...
            return item !== `help.content.faq.technical.items[${index}]` ? item : fallback[index] || item;
          })
        },
        {
          id: "faq-account",
          title: getTranslatedContent("help.content.faq.account.title", "Аккаунт и данные"),
          items: (t("help.content.faq.account.items") as string[]).map((item, index) => {
            const fallback = [
            ...
            return item !== `help.content.faq.account.items[${index}]` ? item : fallback[index] || item;
          })
        },
        {
          id: "faq-premium",
          title: getTranslatedContent("help.content.faq.premium.title", "Premium и монеты"),
          items: (t("help.content.faq.premium.items") as string[]).map((item, index) => {
            const fallback = [
            ...
            return item !== `help.content.faq.premium.items[${index}]` ? item : fallback[index] || item;
          })
        }
      ]
    },
