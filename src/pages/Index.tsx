...
const DashboardContent = memo(function DashboardContent() {
  ...
  const calculatedStreak = useStreak();
    ...
    <>
      ...
      <Suspense fallback={<PageLoader />}>
        <Layout hideNavigation={showWelcome}>
          <div translate="no" className={`w-full ${(showWelcome && !hasError) || (loading && !!dashboardData) ? 'blur-sm pointer-events-none' : ''} transition-all duration-700`}>
            {hasError ? (
