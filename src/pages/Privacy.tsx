...
Для обработки платежей мы используем сторонние платежные процессоры (включая Paddle, Stripe, Telegram Stars и другие), которые могут собирать дополнительную информацию в соответствии со своими политиками конфиденциальности. Мы не храним полные данные вашей платежной карты на наших серверах.`
        },
        {
...
Para procesar pagos utilizamos procesadores de pago de terceros (incluyendo Paddle, Stripe, Telegram Stars y otros), que pueden recopilar información adicional de acuerdo con sus políticas de privacidad. No almacenamos los datos completos de su tarjeta de pago en nuestros servidores.`
        },
        {
...
To process payments, we use third-party payment processors (including Paddle, Stripe, Telegram Stars, and others), which may collect additional information in accordance with their privacy policies. We do not store your full payment card details on our servers.`
        },
        {
