...
• Виртуальная валюта (Монеты) - для косметических предметов в приложении и игровых функций
• Duel Pass - сезонный боевой пас с премиум-наградами
• Все покупки предоставляют доступ к ФУНКЦИЯМ ПРОГРАММНОГО ОБЕСПЕЧЕНИЯ, а не к образовательным сертификатам

ОБРАЗОВАТЕЛЬНЫЙ КОНТЕНТ:
Мы используем общедоступную информацию о безопасности дорожного движения (база вопросов DGT) в качестве исходного материала, аналогично тому, как приложения для изучения языков используют тексты общественного достояния. Однако наша уникальная ценность заключается в нашем собственном программном обеспечении, интерактивном опыте, AI-алгоритмах и механиках геймификации - все это является нашей интеллектуальной собственностью.`
        },
        {
          title: "3. Аккаунты",
