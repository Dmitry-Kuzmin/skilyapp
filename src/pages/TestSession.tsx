          ...
          {mode === "practice" && (
              ...
              <Button
                ...
                <Button
                      ...
                      className="flex-1 font-bold text-sm sm:text-base md:text-lg bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white disabled:bg-muted disabled:text-muted-foreground disabled:cursor-not-allowed h-10 sm:h-11 md:h-12 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl active:scale-[0.98] border-0"
                    >
                      Responder
                </Button>
              )}
