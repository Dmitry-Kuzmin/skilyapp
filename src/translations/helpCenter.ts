...
export const helpCenterTranslations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    "help.content.welcome.intro.content": `Skilyapp — это интерактивное приложение для подготовки к экзамену на получение водительских прав в Испании (DGT). Мы помогаем вам эффективно изучать правила дорожного движения, дорожные знаки и сдавать экзамены с удовольствием.
...
• Приложение предназначено для личного обучения и подготовки к экзамену DGT
...
**2. App Usage:**
• The app is intended for personal learning and DGT exam preparation
...
• Reward history is displayed in the referral program section`,
  ...
  es: {
    ...
    "help.content.welcome.intro.content": `Skilyapp es una aplicación interactiva para preparar el examen de conducir en España (DGT). Te ayudamos a estudiar eficazmente las normas de tráfico, las señales de tráfico y aprobar los exámenes con placer.
...
• La aplicación está destinada al aprendizaje personal y preparación para el examen DGT
