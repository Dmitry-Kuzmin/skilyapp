...
Ответ: Зависит от страны происхождения. ЕС права действительны, для других стран может потребоваться обмен или пересдача.`,
    ...
    "help.content.rules.general.content": `Используя приложение Sdadim, вы соглашаетесь соблюдать следующие правила:
...
• Поддержка: support@sdadim.com или через Telegram`,
...
Answer: Depends on country of origin. EU licenses are valid, for other countries exchange or retake may be required.`,
    ...
    "help.content.rules.general.content": `By using the Sdadim app, you agree to follow these rules:
...
• Support: support@sdadim.com or via Telegram`,
...
Respuesta: Depende del país de origen. Las licencias de la UE son válidas, para otros países puede requerirse intercambio o repetición.`,
    ...
    "help.content.rules.general.content": `Al usar la aplicación Sdadim, aceptas seguir estas reglas:
...
• Soporte: support@sdadim.com o vía Telegram`,
