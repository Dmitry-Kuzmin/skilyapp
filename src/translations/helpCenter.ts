...
export const helpCenterTranslations: Record<Language, Record<string, any>> = {
    ru: {
        ...
        "help.section.duelPass": "Skily Pass",
        "help.section.duelPass.desc": "Система уровней и наград Skily Pass",
...
• Победил игрока с XP 5000 (у вас 4000):
  ...
  - Итого: 310 монет`,
        ...
        "help.content.duelEconomy.season.content": `**Skily Pass:**
• SP ускоряют прогресс Skily Pass
...
• Новых наградах Skily Pass — когда вы достигаете нового уровня
...
• Skily Pass награды — за достижение уровней
...
• Детальная информация о каждой транзакции:
  - Тип операции (тест, дуэль, ежедневный бонус, покупка буста, Skily Pass награда и т.д.)
  - Дата и время
...
• Skily Pass Premium — эксклюзивные награды на каждом уровне Skily Pass
• +20% Season Points (SP) — дополнительный прогресс в Skily Pass за дуэли
...
• **Premium Forever** — автоматическое открытие Skily Pass Premium для всех будущих сезонов
...
• **Premium Forever** — €99.99 (единоразово) 🔥
  ...
  - Автоматическое открытие Skily Pass Premium для всех сезонов
...
• Premium Forever автоматически открывает Skily Pass Premium для всех сезонов
• При Premium Forever вы видите индикатор "Premium Forever активен" в Skily Pass
...
• Watermark в тестах показывает ваше имя (защита от передачи аккаунта)`,
        ...
        // Skily Pass section content
        "help.content.duelPass.overview.title": "Что такое Skily Pass?",
        "help.content.duelPass.overview.content": `Skily Pass — это система уровней и наград, которая мотивирует вас к регулярным занятиям.

За каждое действие (дуэли, выполнение челленджей) вы получаете Season Points (SP) для Skily Pass. При достижении определённого количества SP (100 SP за уровень) вы повышаете уровень и получаете награды.

Прогресс Skily Pass отображается в WalletWidget в виде мини-полоски SP с текущим уровнем.`,
        "help.content.duelPass.levels.title": "Уровни и награды",
        "help.content.duelPass.levels.content": `Skily Pass состоит из 30 уровней, каждый требует 100 SP для достижения:
...
Награды можно получить только один раз за уровень. После получения они отмечаются как "Получено".`,
        "help.content.duelPass.xp.title": "Как заработать Season Points (SP) для Skily Pass",
        "help.content.duelPass.xp.content": `Season Points (SP) — это сезонные очки для прогресса в Skily Pass. Они начисляются за:
...
**Важно:**
• Каждый уровень Skily Pass требует 100 SP
...
• Сезон длится 30 дней (~1 месяц)`,
        ...
        "help.content.duelPass.claiming.content": `Чтобы получить награду Skily Pass:

1. Достигните нужного уровня, накопив достаточно XP
2. Откройте Skily Pass на главной странице или через магазин
...
Награды можно получить в любое время после достижения уровня. Если вы пропустили уровень, вы всё равно можете получить все предыдущие награды.`,
        "help.content.duelPass.premium.title": "Skily Pass Premium",
...
**Как получить Premium Skily Pass:**

• **Premium Forever** — автоматически открыт для всех сезонов (бесплатно)
• **Premium подписка** — автоматически открыт на время подписки
• **Отдельная покупка** — €7.99 за один сезон (через Skily Pass модалку)

Premium Skily Pass можно приобрести отдельно или получить автоматически с Premium подпиской.`,
        "help.content.duelPass.seasons.title": "Сезоны Skily Pass",
        "help.content.duelPass.seasons.content": `Skily Pass работает по сезонам:
...
Выполняйте челленджи регулярно, чтобы максимизировать свой прогресс в Skily Pass!`,
        "help.content.duelPass.ranks.title": "Система рангов",
        "help.content.duelPass.ranks.content": `Ваш ранг в Skily Pass определяется уровнем, которого вы достигли в текущем сезоне:
...
• Повышайте уровень Skily Pass (каждый уровень = 100 SP)
• Участвуйте в сезонных событиях
• Premium пользователи получают +20% SP за дуэли

Ваш ранг отображается в профиле и лидерборде!`,
        "help.content.duelPass.leaderboard.title": "Лидерборд Skily Pass",
        "help.content.duelPass.leaderboard.content": `Лидерборд показывает лучших игроков текущего сезона Skily Pass.

**Что отображается:**
• Позиция в рейтинге (1, 2, 3...)
• Аватар и имя игрока
• Текущий уровень Skily Pass
...
Все косметические предметы можно получить через Skily Pass, ежедневные награды и специальные события. Каждый предмет имеет свою редкость и уникальные визуальные эффекты.
...
• Пополняйте запас через Skily Pass и награды`,
...
• **Skily Pass** — основной источник косметики:
...
• Статистика коллекции`,
        ...
        "help.content.cosmetics.animation.content": `При получении косметики через Skily Pass показывается специальная анимация:
...
• **Регулярно проходите Skily Pass** — основной источник косметики
...
3. Premium & Skily Pass — подписки и премиум функции:
...
• **Double SP Boost:**
  ...
  - Идеально для быстрого прогресса в Skily Pass`,
...
Все покупки сохраняются в истории транзакций.`,
        ...
        "help.content.shop.premium.content": `Получить Premium можно через вкладку "Premium & Skily Pass":
...
**Что важно знать:**
Каждое списание за неактивность теперь фиксируется в журнале с указанием **точной даты пропущенного дня**. Это позволяет точно отслеживать, когда именно были списаны баллы и за какой период.
...
• История наград отображается в разделе реферальной программы`,
        ...
        "help.content.faq.premium.items": [
            ...
            "Что включает Premium? — Безлимитный доступ, удвоенные награды, Skily Pass Premium, без рекламы",
            "Что такое Premium Forever? — Пожизненная Premium подписка за €99.99, автоматически открывает Skily Pass Premium для всех сезонов",
            ...
            "Что такое Skily Pass? — Система уровней и наград за регулярные занятия",
            "Что такое Season Points (SP)? — Сезонные очки для прогресса в Skily Pass, зарабатываются за дуэли и челленджи",
    ...
    en: {
        ...
        "help.section.duelPass": "Skily Pass",
        "help.section.duelPass.desc": "Skily Pass level and reward system",
        ...
        "help.section.examReadiness": "Exam Readiness",
        "help.section.examReadiness.desc": "DGT passing probability and statistics interpretation",
...
• Accelerate Skily Pass progress
...
• Defeated player with 5000 XP (you have 4000):
  ...
  - Total: 310 coins`,
        ...
        "help.content.duelEconomy.season.content": `**Skily Pass:**
• SP accelerate Skily Pass progress
...
• New Skily Pass rewards — when you reach a new level
...
• Skily Pass rewards — for reaching levels
...
• Detailed information about each transaction:
  - Operation type (test, duel, daily bonus, boost purchase, Skily Pass reward, etc.)
  - Date and time
...
• Skily Pass Premium — exclusive rewards at every Skily Pass level
• +20% Season Points (SP) — additional progress in Skily Pass for duels
...
• **Premium Forever** — automatic unlock of Skily Pass Premium for all future seasons
...
• **Premium Forever** — €99.99 (one-time) 🔥
  ...
  - Automatic unlock of Skily Pass Premium for all seasons
...
• Premium Forever automatically unlocks Skily Pass Premium for all seasons
• With Premium Forever you see "Premium Forever active" indicator in Skily Pass
...
• Watermark in tests shows your name (account transfer protection)`,
        ...
        // Skily Pass section content
        "help.content.duelPass.overview.title": "What is Skily Pass?",
        "help.content.duelPass.overview.content": `Skily Pass is a level and reward system that motivates you to practice regularly.

For each action (duels, completing challenges) you receive Season Points (SP) for Skily Pass. When you reach a certain amount of SP (100 SP per level), you level up and receive rewards.

Skily Pass progress is displayed in WalletWidget as a mini SP bar with current level.`,
        "help.content.duelPass.levels.title": "Levels and Rewards",
        "help.content.duelPass.levels.content": `Skily Pass consists of 30 levels, each requiring 100 SP to reach:
...
Rewards can only be claimed once per level. After claiming, they are marked as "Claimed".`,
        "help.content.duelPass.xp.title": "How to Earn Season Points (SP) for Skily Pass",
        "help.content.duelPass.xp.content": `Season Points (SP) are seasonal points for progress in Skily Pass. They are awarded for:
...
**Important:**
• Each Skily Pass level requires 100 SP
...
• Season lasts 30 days (~1 month)`,
        ...
        "help.content.duelPass.claiming.content": `To claim a Skily Pass reward:

1. Reach the required level by accumulating enough XP
2. Open Skily Pass on main page or via shop
...
• **Separate purchase** — €7.99 for one season (via Skily Pass modal)

Premium Skily Pass can be purchased separately or obtained automatically with Premium subscription.`,
        "help.content.duelPass.seasons.title": "Skily Pass Seasons",
        "help.content.duelPass.seasons.content": `Skily Pass works in seasons:
...
Complete challenges regularly to maximize your Skily Pass progress!`,
        "help.content.duelPass.ranks.title": "Ranking System",
        "help.content.duelPass.ranks.content": `Your rank in Skily Pass is determined by the level you reach in the current season:
...
• Increase Skily Pass level (each level = 100 SP)
...
Your rank is displayed in your profile and leaderboard!`,
        "help.content.duelPass.leaderboard.title": "Skily Pass Leaderboard",
        "help.content.duelPass.leaderboard.content": `The leaderboard shows the best players of the current Skily Pass season.

**What's Displayed:**
• Ranking position (1, 2, 3...)
• Player avatar and name
• Current Skily Pass level
...
All cosmetic items can be obtained through Skily Pass, daily rewards and special events. Each item has its own rarity and unique visual effects.
...
• Replenish stock through Skily Pass and rewards`,
...
• **Skily Pass** — main source of cosmetics:
...
• Collection statistics`,
        ...
        "help.content.cosmetics.animation.content": `When obtaining cosmetics through Skily Pass, a special animation is shown:
...
• **Regularly complete Skily Pass** — main source of cosmetics
...
3. Premium & Skily Pass — subscriptions and premium features:
...
• **Double SP Boost:**
  ...
  - Perfect for quick Skily Pass progress`,
...
All purchases are saved in transaction history.`,
        ...
        "help.content.shop.premium.content": `You can get Premium through the "Premium & Skily Pass" tab:
...
Every inactivity decay is now recorded in the journal with the **exact date of the missed day**. This ensures full transparency, allowing you to track exactly when and why points were deducted.
...
• Reward history is displayed in the referral program section`,
        ...
        "help.content.faq.premium.items": [
            ...
            "What does Premium include? — Unlimited access, doubled rewards, Skily Pass Premium, ad-free",
            "What is Premium Forever? — Lifetime Premium subscription for €99.99, automatically unlocks Skily Pass Premium for all seasons",
            ...
            "What is Skily Pass? — Level and reward system for regular practice",
            "What are Season Points (SP)? — Seasonal points for Skily Pass progress, earned for duels and challenges",
    ...
    es: {
        ...
        "help.section.duelPass": "Skily Pass",
        "help.section.duelPass.desc": "Sistema de niveles y recompensas Skily Pass",
        ...
        "help.section.examReadiness": "Preparación para el Examen",
        "help.section.examReadiness.desc": "Probabilidad de aprobar el DGT e interpretación de estadísticas",
...
• Aceleran el progreso de Skily Pass
...
• Derrotaste a jugador con 5000 XP (tú tienes 4000):
  ...
  - Total: 310 monedas`,
        ...
        "help.content.duelEconomy.season.content": `**Skily Pass:**
• Los SP aceleran el progreso de Skily Pass
...
• Nuevas recompensas de Skily Pass — cuando alcanzas un nuevo nivel
...
• Recompensas de Skily Pass — por alcanzar niveles
...
• Información detallada sobre cada transacción:
  - Tipo de operación (prueba, duelo, bono diario, compra de potenciador, recompensa Skily Pass, etc.)
  - Fecha y hora
...
• Obtén recompensas de Skily Pass
...
• Skily Pass Premium — recompensas exclusivas en cada nivel de Skily Pass
• +20% Season Points (SP) — progreso adicional en Skily Pass por duelos
...
• **Premium Forever** — desbloqueo automático de Skily Pass Premium para todas las temporadas futuras
...
• **Premium Forever** — €99.99 (única vez) 🔥
  ...
  - Desbloqueo automático de Skily Pass Premium para todas las temporadas
...
• Premium Forever desbloquea automáticamente Skily Pass Premium para todas las temporadas
• Con Premium Forever ves el indicador "Premium Forever activo" en Skily Pass
...
• La marca de agua en las pruebas muestra tu nombre (protección contra transferencia de cuenta)`,
        ...
        // Skily Pass section content
        "help.content.duelPass.overview.title": "¿Qué es Skily Pass?",
        "help.content.duelPass.overview.content": `Skily Pass es un sistema de niveles y recompensas que te motiva a practicar regularmente.

Por cada acción (duelos, completar desafíos) recibes Season Points (SP) para Skily Pass. Al alcanzar cierta cantidad de SP (100 SP por nivel), subes de nivel y recibes recompensas.

El progreso de Skily Pass se muestra en WalletWidget como una mini barra SP con el nivel actual.`,
        "help.content.duelPass.levels.title": "Niveles y Recompensas",
        "help.content.duelPass.levels.content": `Skily Pass consta de 30 niveles, cada uno requiere 100 SP para alcanzar:
...
Las recompensas solo se pueden reclamar una vez por nivel. Después de reclamar, se marcan como "Reclamado".`,
        "help.content.duelPass.xp.title": "Cómo Ganar Season Points (SP) para Skily Pass",
        "help.content.duelPass.xp.content": `Los Season Points (SP) son puntos estacionales para progreso en Skily Pass. Se otorgan por:
...
**Importante:**
• Cada nivel de Skily Pass requiere 100 SP
...
• La temporada dura 28 días (4 semanas)`,
        ...
        "help.content.duelPass.claiming.content": `Para reclamar una recompensa de Skily Pass:

1. Alcanza el nivel requerido acumulando suficiente XP
2. Abre Skily Pass en la página principal o a través de la tienda
...
**Cómo Obtener Skily Pass Premium:**
...
• **Compra Separada** — €7.99 por una temporada (a través del modal de Skily Pass)

Skily Pass Premium se puede comprar por separado u obtener automáticamente con suscripción Premium.`,
        "help.content.duelPass.seasons.title": "Temporadas de Skily Pass",
        "help.content.duelPass.seasons.content": `Skily Pass funciona por temporadas:
...
¡Completa desafíos regularmente para maximizar tu progreso en Skily Pass!`,
...
Todos los objetos cosméticos se pueden obtener a través de Skily Pass, recompensas diarias y eventos especiales. Cada objeto tiene su propia rareza y efectos visuales únicos.
...
• Repone el stock a través de Skily Pass y recompensas`,
...
• **Skily Pass** — fuente principal de cosméticos:
...
• Estadísticas de colección`,
        ...
        "help.content.cosmetics.animation.content": `Al obtener cosméticos a través de Skily Pass, se muestra una animación especial:
...
• **Completa Skily Pass regularmente** — fuente principal de cosméticos
...
3. Premium & Skily Pass — suscripciones y funciones premium:
...
• **Double SP Boost:**
  ...
  - Perfecto para progreso rápido en Skily Pass`,
...
Todas las compras se guardan en el historial de transacciones.`,
        ...
        "help.content.shop.premium.content": `Puedes obtener Premium a través de la pestaña "Premium & Skily Pass":
...
**Lo que debes saber:**
Cada reducción por inactividad se registra ahora en el diario con la **fecha exacta del día perdido**. Esto le permite rastrear exactamente cuándo y por qué se restaron los puntos.
...
• El historial de recompensas se muestra en la sección del programa de referidos`,
        ...
        "help.content.faq.premium.items": [
            ...
            "¿Qué incluye Premium? — Acceso ilimitado, recompensas duplicadas, Skily Pass Premium, sin anuncios",
            "¿Qué es Premium Forever? — Suscripción Premium de por vida por €99.99, desbloquea automáticamente Skily Pass Premium para todas las temporadas",
            ...
            "¿Qué es Skily Pass? — Sistema de niveles y recompensas por práctica regular",
            "¿Qué son Season Points (SP)? — Puntos estacionales para progreso en Skily Pass, se ganan por duelos y desafíos",
