...
export const landingTranslations: Record<Language, LandingCopy> = {
  ...
  ru: {
    ...
    liveClass: {
      badge: "ОНЛАЙН-КУРС",
      title: "Полный курс теории с преподавателем",
      subtitle: "2 месяца — от нуля до экзамена",
      description: "Живые занятия в Zoom, разбор реальных билетов, мини-группы до 15 человек. Записи остаются навсегда.",
      stats: [
        { value: "8", label: "недель" },
        { value: "16", label: "занятий" },
        { value: "2×", label: "в неделю" },
        { value: "∞", label: "записи" },
      ],
      schedule: "Вт и Чт • 19:00 CET",
