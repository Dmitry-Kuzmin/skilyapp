...
export const landingTranslations: Record<Language, LandingCopy> = {
  ...
  ru: {
    ...
    liveClass: {
      badge: "Онлайн курс",
      title: "Учись с сертифицированным преподавателем",
      description: "Интерактивные занятия 2 раза в неделю с преподавателем, сертифицированным по ПДД. Задавай вопросы в реальном времени и ускоряй своё обучение.",
      schedule: "Вторник и четверг • 19:00 CET",
      features: [
        "2 живых занятия в неделю",
