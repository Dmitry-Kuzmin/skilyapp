export const en = {
  celebration: {
    ...
    you: "You",
    player: "Player",
    overtookPlayers: "🚀 You overtook {{count}} player{{plural}}!",
    overtookPlural_one: "",
    overtookPlural_other: "s",
    fullRanking: "Full ranking →",
    bonus: "bonus 🎯",
    level: "Level",
    seasonLeaderboard: "Season leaderboard",
    currentPosition: "Your current position in the season",
    loadingPosition: "Loading position…",
    firstResult: "First result",
    newRecord: "New record",
    personalBest: "Personal best",
    recordSet: "Record set — now something to beat 🔥",
    toRecord: " to record 🎉",
    today: "Today",
    record: "Record",
    moreToRecord: "{{count}} more answer{{plural}} to record",
    moreToRecordPlural_one: "",
    moreToRecordPlural_other: "s",
    xpEarned: "Experience earned",
    movingToMastery: "You are moving towards mastery 🎓",
    workOn: "Work on",
    topicsToReview: "These topics are worth repeating",
    examReadiness: "Exam readiness",
    toReadiness: " to readiness ↑",
    readyForExam: "You are ready for the exam! 🏆",
    excellentProgress: "Excellent progress! Keep it up",
    everyTestIncreases: "Every test increases readiness",
    greatJob: "Great job!",
    dontGiveUp: "Don't give up!",
    passedDesc: "You did great on this test. Keep it up!",
    failedDesc: "Every attempt makes you stronger. Review topics and try again!",
    todayTestCount: "🔥 This is your {{count}}th test today!",
    nextTest: "Next test",
    testDetails: "Test details",
    skip: "Skip",
    next: "Next",
    seasonLeaderboardTitle: "Season leaderboard",
    close: "Close",
    loading: "Loading…",
    coins: "{{count}} coins",
    ...
    premiumOnlyDesc: "This reward is only available with Elite Pass",
    alreadyClaimed: "Reward already claimed",
    getElitePass: "Get Elite Pass",
    claiming: "Claiming...",
    claimed: "Claimed!",
  ...
  notifications: {
    ...
    emptyUnread: "No new notifications",
  ...
  favoritesGym: {
    ...
    requireCharge: "Need recharge",
    searchPlaceholder: "Search question...",
    batteryCharge: "Memory charge",
    correctAnswer: "CORRECT ANSWER",
    answerNotFound: "Answer not found",
    conciseExplanation: "Quick gist",
    tapToFlipBack: "Tap to flip back",
    filters: {
      all: "All",
      lowBattery: "Low charge",
    ...
    empty: {
      title: "Empty",
      description: "Try changing filters or add new questions to favorites",
  ...
  dashboard: {
    ...
    examReadiness: {
      ...
      overlay: {
        dashboardTitle: "Skily Telemetry Dashboard",
        syncing: "Telemetry Syncing...",
        ...
        diagnostic: {
          ...
          criticalRisk: "Critical risk zones",
          description: "We found {{count}} critical gaps in your knowledge. We recommend working through them in the Hard Questions Bank before the exam.",
          fixNow: "Fix errors now",
        },
        systemsNominal: {
          title: "All systems nominal",
          description: "No errors were detected in critical topics. You're doing great!",
        },
      },
      noData: {
    ...
    rewardedAds: {
      ...
      placements: {
        cryptoMiner: {
          ...
          ready: "READY",
          watchAd: "Watch ads — earn coins",
          limitReached: "Limit reached — come back tomorrow",
  ...
  boostShop: {
    ...
    payment: {
      ...
      cryptoPaymentTitle: "Cryptocurrency Payment",
      cardTitle: "Bank Card",
    ...
    premium: {
      ...
      benefits: {
        ...
        duelPassRewards: "Premium Skily Pass rewards",
    ...
    duelPass: {
      ...
      button: "Open Skily Pass",
      toastTitle: "Skily Pass",
      toastDescription: "Open Skily Pass on the home page",
      oneTime: "one-time",
      features: {
    ...
    history: {
      ...
      empty: {
        ...
        reward: {
          title: "No rewards",
          description: "Earn rewards from Skily Pass, referrals and achievements.",
        },
      },
    ...
    transactions: {
      ...
      duelPassPurchase: "Skily Pass purchase",
      duelPassReward: "Skily Pass reward{{level}}{{premium}}",
  ...
  wallet: {
    ...
    copied: "Copied!",
    connect: "Connect",
    duelPassTooltipMobile: "Skily Pass Level {{level}} — {{xp}} SP",
    duelPassTooltipDesktop: "Skily Pass Level {{level}} — click to view season",
  ...
  duelPass: {
    ...
    premiumBanner: {
      ...
      freeBadge: "Free",
      descriptionForever: "You already own Premium Forever — Skily Pass is unlocked!",
      descriptionQuestion: "What is Skily Pass?",
    ...
    premiumForever: {
      ...
      description: "Skily Pass unlocked for every season",
    },
    upcomingSeason: {
    ...
    leaderboard: {
      errors: {
        load: "Failed to load the leaderboard. Please try again later.",
        position: "Failed to load your position. Please try again later.",
      },
      seasonBadge: "Competitive season",
      title: "Top players",
      subtitle: "Fight in duels, stack XP and grab Premium or 1000 coins at the end of the season.",
      ...
      myPlace: "My place",
      positionOf: "Position {{position}} of {{total}}",
      hide: "Hide",
      neighbors: "Neighbors",
      player: "Player",
      you: "You",
      ...
      lockedTitle: "You're not in the season yet",
      lockedDescription: "Earn your first SP to enter the leaderboard and compete for rewards.",
      duelRewardHint: "Duel: +10 SP",
      testRewardHint: "Test: +5 SP",
      participants: {
        one: "Already {{count}} participant this season",
        other: "Already {{count}} participants this season",
      },
      podium: {
        prize: "Prize",
        reward: "Reward",
    ...
    onboarding: {
      slide1: {
        title: "Welcome to<br />Skily Pass!",
      ...
      dialogDescription: "Welcome to Skily Pass - activity reward system",
    },
    migration: {
      title: "Skily Pass",
  ...
  duelMenu: {
    ...
    finding: {
      ...
      waitingForResponse: "Waiting for response from {{name}}...",
      searchSubtitle: "Matching you with a worthy opponent in real time...",
      cancel: "Cancel search",
      toasts: {
        callingRematch: "Calling {{name}} for a rematch...",
        acceptedChallenge: "{{name}} accepted your challenge",
        opponentFound: "Opponent found!",
        opponentFoundNamed: "Opponent {{name}} found!",
        challengeSent: "⚔️ Challenge sent to {{name}}! Waiting in the lobby...",
        duelCreated: "⚔️ Duel created! Send this code to your friend: {{code}}",
      },
    },
  },
  duelResult: {
  ...
  testResults: {
    ...
    bonusHint: {
      title: "Reach <b>90%</b> — get <b>+30 SP bonus</b>",
      subtitle: "For a perfect score (100%) — <b>+50 SP</b>!",
    },
    perfectBonus: {
      title: "Perfect score! 🔥",
      subtitle: "+50 SP bonus for a flawless run",
    },
    greatBonus: {
      title: "Great result! +30 SP bonus ⚡",
      subtitle: "100% gives even more — <b>+50 SP</b>",
    },
    redemption: {
  ...
  gamesPage: {
    ...
    gameTitles: {
      ...
      race: "Race",
      lexicon: "Lexicon: Cards",
      roadRules: "Road Cards",
      intersections: "Intersections",
      lexicon_old: "Lexicon",
      guessSign: "Guess the Sign",
      roadRace: "Road Race",
      speedQuiz: "Speed Limits",
      blitz: "Blitz",
    },
    gameDescriptions: {
      duel: "Compete with a friend or a bot on traffic rules knowledge",
      race: "Translate as many words as possible in a limited time",
      lexicon: "Learn Spanish road terms through card translation",
      roadRules: "Memorize road rules through interactive cards with theory",
      intersections: "Solve the traffic! Choose the correct order of passage",
      lexicon_old: "Translation mastery. Choose the correct meaning of traffic terms.",
      guessSign: "Test your knowledge of road signs in a premium game",
      roadRace: "Test marathon in a race format on Spanish roads",
      speedQuiz: "Test your knowledge of Spanish speed limits: from highways to residential zones.",
  ...
  help: {
    section: {
      welcome: "Welcome",
      "welcome.desc": "Get started with the basics and learn about Skilyapp",
      duelEconomy: "Duels, Bets & Insurance",
      "duelEconomy.desc": "PvP battle system with coins and ratings",
      appUsage: "App Usage",
      "appUsage.desc": "How tests, games, learning and AI work",
      notifications: "Notifications & Reminders",
      "notifications.desc": "Alert system and notification settings",
      rewards: "Reward System",
      "rewards.desc": "Achievements, bonuses and referrals",
      experience: "Experience System (XP)",
      "experience.desc": "How ratings and levels work",
      coins: "Coin System",
      "coins.desc": "How to earn and spend coins",
      premium: "Premium Subscription",
      "premium.desc": "Benefits of paid subscription",
      duelPass: "Skily Pass",
      "duelPass.desc": "Seasonal progress and reward system",
      cosmetics: "Cosmetics",
      "cosmetics.desc": "Skins, badges and stickers",
      shop: "Shop",
      "shop.desc": "How to buy items and subscriptions",
      examReadiness: "Exam Readiness",
