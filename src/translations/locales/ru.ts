export const ru = {
  celebration: {
    ...
    accuracy: "Точность",
    time: "Время",
    seasonRanking: "Сезонный рейтинг",
    you: "Ты",
    player: "Игрок",
    overtookPlayers: "🚀 Ты обогнал {{count}} {{plural}}!",
    overtookPlural_one: "игрока",
    overtookPlural_other: "игроков",
    fullRanking: "Полный рейтинг →",
    bonus: "бонус 🎯",
    level: "Уровень",
    seasonLeaderboard: "Сезонный лидерборд",
    currentPosition: "Твоя текущая позиция в сезоне",
    loadingPosition: "Загружаем позицию…",
    firstResult: "Первый результат",
    newRecord: "Новый рекорд",
    personalBest: "Личный рекорд",
    recordSet: "Рекорд установлен — теперь есть что побить 🔥",
    toRecord: " к рекорду 🎉",
    today: "Сегодня",
    record: "Рекорд",
    moreToRecord: "Ещё {{count}} {{plural}} до рекорда",
    moreToRecordPlural_one: "ответ",
    moreToRecordPlural_few: "ответа",
    moreToRecordPlural_other: "ответов",
    xpEarned: "Опыт заработан",
    movingToMastery: "Ты продвигаешься к мастерству 🎓",
    workOn: "Поработай над",
    topicsToReview: "Эти темы стоит повторить",
    examReadiness: "Готовность к экзамену",
    toReadiness: " к готовности ↑",
    readyForExam: "Ты готов к экзамену! 🏆",
    excellentProgress: "Отличный прогресс! Продолжай так",
    everyTestIncreases: "Каждый тест повышает готовность",
    greatJob: "Отличная работа!",
    dontGiveUp: "Не сдавайся!",
    passedDesc: "Ты отлично справился с этим тестом. Продолжай в том же духе!",
    failedDesc: "Каждая попытка делает тебя сильнее. Повтори темы и попробуй снова!",
    todayTestCount: "🔥 Это твой {{count}}-й тест сегодня!",
    nextTest: "Следующий тест",
    testDetails: "Детали теста",
    skip: "Пропустить",
    next: "Дальше",
    seasonLeaderboardTitle: "Лидерборд сезона",
    close: "Закрыть",
    loading: "Загрузка…",
    coins: "{{count}} монет",
    failedToClaim: "Не удалось забрать награду",
    claimError: "Ошибка получения награды",
    newLevel: "Новый уровень",
    missedOpportunity: "Упущенная выгода",
    premiumOnlyDesc: "Эта награда доступна только с Elite Pass",
    alreadyClaimed: "Награда уже получена ранее",
    getElitePass: "Получить Elite Pass",
    claiming: "Получаем...",
    claimed: "Получено!",
  ...
  notifications: {
    ...
    emptyUnread: "Нет новых уведомлений",
  ...
  favoritesGym: {
    ...
    requireCharge: "Требуют заряда",
    searchPlaceholder: "Найти вопрос...",
    batteryCharge: "Заряд памяти",
    correctAnswer: "ПРАВИЛЬНЫЙ ОТВЕТ",
    answerNotFound: "Ответ не найден",
    conciseExplanation: "Суть кратко",
    tapToFlipBack: "Нажми, чтобы вернуть",
    filters: {
      all: "Все",
      lowBattery: "Слабый заряд",
    ...
    empty: {
      title: "Пусто",
      description: "Попробуйте изменить фильтры или добавьте новые вопросы в избранное",
  ...
  dashboard: {
    ...
    examReadiness: {
      ...
      overlay: {
        dashboardTitle: "Панель Телеметрии Skily",
        syncing: "Синхронизация телеметрии...",
        ...
        kpis: {
          mileage: "Учебный пробег",
          totalAnswers: "всего ответов",
          accuracy: "Точность",
          correctAnswers: "{{count}} правильных",
          duelWinrate: "Winrate дуэлей",
          victories: "{{count}} побед",
          dailyStreak: "Daily Streak",
          daysInRow: "дней подряд",
        },
        diagnostic: {
          result: "Результат диагностики",
          errorsFound: "{{count}} ОШИБОК",
          criticalRisk: "Критические зоны риска",
          description: "Мы обнаружили {{count}} критических пробелов в твоих знаниях. Рекомендуем проработать их в Банке Сложных Вопросов перед сдачей.",
          fixNow: "Исправить ошибки сейчас",
        },
        systemsNominal: {
          title: "Все системы в норме",
          description: "Ошибок в критических темах не обнаружено. Ты отлично справляешься!",
        },
      },
      noData: {
  ...
  licenseCard: {
    ...
    licenceEvents: {
      ...
      topic_perfect: "Идеальная тема",
      marathon_completed: "Марафон пройден",
      exam_pass: "Экзамен сдан",
      exam_fail: "Экзамен не сдан",
      critical_error: "Критическая ошибка",
      inactivity_decay: "Штраф за неактивность",
      rehabilitation_pass: "Курс восстановления",
    },
  ...
  skilyChat: {
    title: "Skily AI",
    subtitle: "Задай вопрос по ПДД",
    placeholder: "Задать вопрос...",
    neuralCore: "Skily AI",
    online: "ОНЛАЙН",
    processing: "ДУМАЮ...",
    ready: "Готов помочь!",
    description: "Задай любой вопрос по правилам — объясню логику и помогу разобраться.",
    modelInfo: "SKILY AI // INSTRUCTOR MODE",
  ...
  wallet: {
    ...
    openExplorer: "Открыть в Tonviewer",
  ...
  duelPass: {
    ...
    leaderboard: {
      errors: {
        load: "Не удалось загрузить рейтинг. Попробуйте позже.",
        position: "Не удалось загрузить вашу позицию. Попробуйте позже.",
      },
      seasonBadge: "Соревновательный сезон",
      title: "Топ игроков",
      subtitle: "Сражайся в дуэлях, копи XP и забирай Premium или 1000 монет в конце сезона.",
      ...
      myPlace: "Моё место",
      positionOf: "Позиция {{position}} из {{total}}",
      hide: "Скрыть",
      neighbors: "Соседи",
      player: "Игрок",
      you: "Вы",
      level: "Уровень {{level}}",
      levelShort: "Ур. {{level}}",
      lockedTitle: "Ты ещё не в сезоне",
      lockedDescription: "Заработай первые SP, чтобы попасть в рейтинг и побороться за призы.",
      duelRewardHint: "Дуэль: +10 SP",
      testRewardHint: "Тест: +5 SP",
      participants: {
        one: "Уже {{count}} участник в этом сезоне",
        few: "Уже {{count}} участника в этом сезоне",
        many: "Уже {{count}} участников в этом сезоне",
      },
      podium: {
        prize: "Приз",
        reward: "Награда",
  ...
  blogPage: {
    title: "Блог",
    home: "Главная",
    description: "Полезные статьи об изучении правил дорожного движения и подготовке к экзамену DGT",
    ...
    cta: {
      ...
      description: "Присоединяйтесь к тысячам студентов, которые уже готовятся к экзамену DGT с помощью Skilyapp",
  ...
  unifiedSettings: {
    ...
    notificationsKeys: {
      ...
      pwaInstallTitle: "Добавьте приложение на экран «Домой»",
      pwaInstallDesc: "Для получения уведомлений на iOS нажмите Поделиться, затем На экран «Домой».",
      pushLabel: "Push-уведомления",
      pushActiveDesc: "Активно • Вы получаете уведомления",
      pushPwaRequired: "Требуется установка PWA (iOS)",
      pushEnableDesc: "Включите для получения уведомлений",
      testButton: "🧪 Отправить тестовое уведомление",
      settingsTitle: "Настройки уведомлений",
      duelLabel: "Уведомления о дуэлях",
      duelDesc: "Вызовы, результаты, награды",
      remindersLabel: "Напоминания об обучении",
      remindersDesc: "Ежедневные напоминания",
      emailLabel: "Email-рассылка",
      emailDesc: "Новости и обновления",
      comingSoon: "Скоро!",
      ...
      settingsChangeFailed: "Не удалось изменить настройки",
      testSent: "Тестовое уведомление отправлено!",
      testFailed: "Не удалось отправить уведомление",
      duelNotificationsOn: "Уведомления о дуэлях включены",
      duelNotificationsOff: "Уведомления о дуэлях выключены"
    },
    dataKeys: {
    ...
    aboutKeys: {
      ...
      app: "Приложение",
      blog: "Блог",
      blogDesc: "Новости и статьи",
      partners: "Партнеры",
      partnersDesc: "Стать партнером",
      aboutProject: "О нас",
      aboutProjectDesc: "Наша миссия",
      pricing: "Цены",
      pricingDesc: "Тарифы и планы",
      privacy: "Конфиденциальность",
      privacyDesc: "Политика конфиденциальности",
      terms: "Правила",
      termsDesc: "Условия использования",
      cookies: "Cookies",
      cookiesDesc: "Настройки cookies",
      helpCenter: "Центр помощи",
      contactSupport: "Связаться с поддержкой",
      whatsNew: "Что нового",
      whatsNewDesc: "История обновлений",
      newBadge: "NEW",
      version: "Версия",
      versionCurrent: "актуальная"
    }
  },
  nav: {
    settings: "Настройки",
  ...
  duelMenu: {
    ...
    finding: {
      ...
      friendFallback: "друга",
      waitingForResponse: "Ждём ответа от {{name}}...",
      searchSubtitle: "Подбираем достойного оппонента в реальном времени...",
      cancel: "Отменить поиск",
      toasts: {
        callingRematch: "Вызываем {{name}} на реванш...",
        acceptedChallenge: "{{name}} принимает ваш вызов!",
        opponentFound: "Соперник найден!",
        opponentFoundNamed: "Соперник {{name}} найден!",
        challengeSent: "⚔️ Вызов отправлен {{name}}! Ждём его в лобби...",
        duelCreated: "⚔️ Дуэль создана! Отправь другу код: {{code}}",
      },
    },
  },
  duelResult: {
  ...
  testResults: {
    noData: "Нет данных о результатах",
    ...
    redemption: {
      ...
      description: "Безупречное закрепление. Потерянный рейтинг возвращён на 50%.",
    },
    marathonGoalAchieved: "🏆 Марафон: цель достигнута!",
    marathonRoundCompleted: "🏃 Марафон: раунд {{round}} завершён",
    examPassed: "🎉 Экзамен сдан!",
    examFailed: "Экзамен не сдан",
    failNotice: "Допущено {{count}} {{errorWord}}. Это критично для экзамена {{exam}}.",
    errorWords: {
      one: "ошибка",
      few: "ошибки",
      many: "ошибок",
    ...
    passMessages: {
      marathon: "Вы успешно отработали ошибки этого раунда. Марафон продолжается до полного успеха.",
      exam: "Отличный результат! Продолжайте в том же духе.",
    },
    stats: {
      time: "Время",
      accuracy: "Точность",
    ...
    questionImageAlt: "Вопрос",
    questionDetails: "Детали вопроса",
    aiExplanation: "Объяснение AI",
    smartDebrief: {
      ...
      header: {
        analysisWithCountry: "Анализ: {{country}}",
        systemAnalysis: "Системный анализ",
        errors: "ошибок",
      },
      ...
      analysisFallbackTitle: "Анализ ошибок",
      analysisFallbackBody: "Данные анализа недоступны",
      decisionLogic: "Логика решений",
      noImage: "Нет изображения",
      questionLabel: "Вопрос",
      russiaDifference: "🇷🇺 vs 🇪🇸 ОТЛИЧИЕ ОТ РОССИИ",
      memoryHack: "Лайфхак запоминания",
      later: "Позже",
      practiceError: "Отработать ошибку",
      signInDescription: "Войдите, чтобы получить AI-разбор ошибок",
      signIn: "Войти",
      readyBadge: "Анализ завершён",
      readyTitle: "Инсайты сформированы",
      readyDescription: "Skily нашёл глубинные причины твоих ошибок. Раскрой их прямо сейчас.",
      criticalPattern: "Обнаружен критический паттерн ошибок",
      drawerTitle: "AI Analysis",
      limitMessage: "Лимит на сегодня исчерпан. Скоро ты сможешь разбирать каждую ошибку!",
      errors: {
        authRequired: "Требуется авторизация",
        emptyResult: "AI вернул пустой результат",
        toast: "ИИ не смог разобрать ошибки: {{message}}",
        analysisFailed: "Анализ не удался: {{message}}",
      },
    },
  },
  gamesPage: {
    ...
    gameTitles: {
      duel: "Дуэль с другом",
      race: "Гонка",
      lexicon: "Лексикон: Карточки",
      roadRules: "Дорожные карточки",
    ...
    gameDescriptions: {
      ...
      lexicon: "Учи испанские термины ПДД через перевод карточек",
      roadRules: "Запоминай правила ПДД через интерактивные карточки с теорией",
  ...
  help: {
    section: {
      welcome: "Добро пожаловать",
      "welcome.desc": "Начни с основ и узнай, что такое Skilyapp",
      duelEconomy: "Дуэли, ставки и страховка",
      "duelEconomy.desc": "Система PvP баттлов с монетами и рейтингом",
      appUsage: "Использование приложения",
      "appUsage.desc": "Как работают тесты, игры, обучение и AI",
      notifications: "Уведомления и напоминания",
      "notifications.desc": "Система оповещений и настройка уведомлений",
      rewards: "Система наград",
      "rewards.desc": "Достижения, бонусы и рефералы",
      experience: "Система опыта (XP)",
      "experience.desc": "Как работает рейтинг и уровни",
      coins: "Система монет",
      ...
      shop: "Магазин",
      "shop.desc": "Как покупать предметы и подписки",
      examReadiness: "Готовность к экзамену",
      "examReadiness.desc": "Вероятность сдачи DGT и интерпретация статистики",
    },
  },
  guestPaywall: {
    badge: "Skily AI · Диагностика",
    title: "Ты ответил на<br/>3 вопроса!",
    ...
    perks: {
      plan: "ИИ-план по твоим слабым местам",
      duels: "PvP дуэли 1vs1 в реальном времени",
      explanations: "Объяснения ИИ к каждому вопросу"
    }
  },
  exitTrial: {
    title: "3 дня без риска",
    subtitle: "Попробуй всё без ограничений. Нужна карта, но спишется только на 4-й день — если передумаешь, отменишь за секунду.",
    perk1: "Безлимит тестов",
    perk2: "AI объясняет каждую ошибку",
    perk3: "Мгновенный доступ",
    perk4: "Списание только на 4-й день",
    cta: "Зарегистрироваться бесплатно →",
    skip: "Нет, спасибо"
  },
  pwaPrompt: {
    title: "Добавьте Skily на экран «Домой»",
    subtitle: "Быстрый доступ без браузера. Работает как приложение.",
    step1: "Нажмите ⎙ в панели Safari",
