...
- **`auth-confirm-clean.html`** — Чистая билингвальная версия (ES главный, EN подзаголовок)
  - ✅ Чёткая визуальная иерархия
  - ✅ Защита от инверсии цветов на iPhone
  - ✅ Минималистичный дизайн
  - ✅ Без прозрачных артефактов

### Альтернативные
- `auth-confirm-bilingual.html` — Расширенная билингвальная (два крупных заголовка)
- `auth-confirm-en.html` — только английский
- `auth-confirm-es.html` — только испанский

### Ассеты
- Логотип: `/public/email-assets/skily-logo.png` (72×72px, PNG, без прозрачности)
