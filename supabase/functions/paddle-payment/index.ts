...
const PaymentRequestSchema = z.object({
  ...
  catalog_key: z.enum([
    'premium_monthly', 'premium_quarterly', 'premium_biannual', 'premium_yearly', 'premium_lifetime', 'premium_trial', 'duel_pass_season',
...
const PADDLE_PRICE_IDS: Record<string, string> = {
  ...
  premium_lifetime: 'pri_01kha3v1a8j4e6k8hamxsvpt19',
  premium_trial: 'pri_01kr9cenmdqcrmvc28cjv6ayxg',
...
const CATALOG: Record<string, CatalogEntry> = {
  ...
  premium_trial: { name: "3 Days Free Trial", amountCents: 0, currency: "eur", dbType: "premium", dbItemId: "premium_monthly", description: "3-day free trial, then €9.99/mo" },
