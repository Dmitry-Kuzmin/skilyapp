-- Обновление get_dashboard_super: добавляем preferred_country и preferred_license_category
...
BEGIN
    -- Profile + Premium fields + Country/License preferences
    SELECT json_build_object(
        ...
        'preferred_license_category', preferred_license_category
    ),
    subscription_status,
