...
function updatePublishPanel() {
  ...
  if (r.output) {
    ...
    html += '<div class="publish-file-row">'
      ...
      + '<button class="btn-finder" data-path="' + r.output.replace(/"/g, '&quot;') + '" onclick="revealFile(this.dataset.path)">📂 Finder</button>'
      + '</div>';
  }
  if (r.outputRU) {
    ...
    html += '<div class="publish-file-row">'
      ...
      + '<button class="btn-finder" data-path="' + r.outputRU.replace(/"/g, '&quot;') + '" onclick="revealFile(this.dataset.path)">📂 Finder</button>'
      + '</div>';
  }
