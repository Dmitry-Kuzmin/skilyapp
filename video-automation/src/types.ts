...
export const OUTRO_TEMPLATES = {
  ru: [
    ...
    { id: "skily",      label: "Реклама Skily",    text: "Готовишься к испанским правам? 3000+ вопросов на Skily 🚀" },
  ...
  es: [
    ...
    { id: "skily",      label: "Promo Skily",      text: "¿Preparando el DGT? +3000 preguntas en Skily 🚀" },
